...
enum SnipListIconOptions {
    ...
    static let categories = [
        SnipListIconCategory(title: "Smileys & Emotion", icons: [
        ...
        SnipListIconCategory(title: "People & Body", icons: [
        ...
        SnipListIconCategory(title: "Animals & Nature", icons: [
        ...
        SnipListIconCategory(title: "Food & Drink", icons: [
        ...
        SnipListIconCategory(title: "Travel & Places", icons: [
        ...
        SnipListIconCategory(title: "Activities", icons: [
        ...
        SnipListIconCategory(title: "Objects", icons: [
        ...
        SnipListIconCategory(title: "Symbols", icons: [
        ...
        SnipListIconCategory(title: "Work & Planning", icons: [
        ...
        SnipListIconCategory(title: "Communication", icons: [
            "envelope.open.fill", "phone.arrow.up.right.fill", "video.bubble.left.fill", "megaphone"
        ]),
        SnipListIconCategory(title: "Developer & Data", icons: [
        ...
        SnipListIconCategory(title: "Design & Making", icons: [
        ...
        SnipListIconCategory(title: "Money, Shopping & Security", icons: [
