...
struct SectionIconCategory: Identifiable {
    let title: String
    let icons: [String]
...
enum SectionIconOptions {
    static let recentsDefaultsKey = "recentSectionIcons"

    static let categories = [
        SectionIconCategory(title: "AI & Data", icons: [
        ...
        SectionIconCategory(title: "Developer Tools", icons: [
        ...
        SectionIconCategory(title: "Cloud & Security", icons: [
        ...
        SectionIconCategory(title: "Productivity & Work", icons: [
        ...
        SectionIconCategory(title: "Communication & Social", icons: [
        ...
        SectionIconCategory(title: "Commerce & Marketplaces", icons: [
        ...
        SectionIconCategory(title: "Finance & Business", icons: [
        ...
        SectionIconCategory(title: "Media & Creator", icons: [
        ...
        SectionIconCategory(title: "Health & Fitness", icons: [
        ...
        SectionIconCategory(title: "Education & Knowledge", icons: [
        ...
        SectionIconCategory(title: "Travel & Mobility", icons: [
        ...
        SectionIconCategory(title: "Food & Delivery", icons: [
        ...
        SectionIconCategory(title: "Home & IoT", icons: [
        ...
        SectionIconCategory(title: "Design & Creative", icons: [
        ...
        SectionIconCategory(title: "Fun & Games", icons: [
