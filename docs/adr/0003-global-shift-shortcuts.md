...
Treat Command plus two Left Shift taps as Open or Hide Clipboard. Command must stay held through both taps. It opens the same panel on Clipboard and focuses Search. If that view is already open on the active Space, it hides the panel. Let people change all three global shortcuts.
