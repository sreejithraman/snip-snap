...
print '<rss><channel>\n  <item>\n    <title>0.1.0</title>\n  </item>\n  <item>\n    <title>0.0.1</title>\n  </item>\n</channel></rss>' > "$new_appcast"
assert_succeeds release_policy_require_preserved_appcast_items "$old_appcast" "$new_appcast"
print '<rss><channel><item><title>0.1.0</title></item><item><title>0.0.1</title> <description>changed</description></item></channel></rss>' > "$new_appcast"
...
assert_fails release_policy_require_preserved_appcast_items "$old_appcast" "$new_appcast"
print '<rss><channel><item><title>0.0.1</title><description><![CDATA[<span>Hello</span>\n <span>World</span>]]></description></item></channel></rss>' > "$old_appcast"
print '<rss><channel><item><title>0.1.0</title></item><item><title>0.0.1</title><description><![CDATA[<span>Hello</span><span>World</span>]]></description></item></channel></rss>' > "$new_appcast"
assert_fails release_policy_require_preserved_appcast_items "$old_appcast" "$new_appcast"
print '<rss><channel><item><title>0.0.1</title><description><span>Hello</span>\n <span>World</span></description></item></channel></rss>' > "$old_appcast"
print '<rss><channel><item><title>0.1.0</title></item><item><title>0.0.1</title><description><span>Hello</span><span>World</span></description></item></channel></rss>' > "$new_appcast"
assert_fails release_policy_require_preserved_appcast_items "$old_appcast" "$new_appcast"
print '<rss><channel><item><title>0.0.1</title><enclosure url="release.zip"/></item></channel></rss>' > "$old_appcast"
print "<rss><channel><item><title>0.1.0</title></item><item><title>0.0.1</title><enclosure url='release.zip'/></item></channel></rss>" > "$new_appcast"
assert_fails release_policy_require_preserved_appcast_items "$old_appcast" "$new_appcast"
print '<rss><channel><item><title>0.0.1</title><enclosure url="release.zip"/></item></channel></rss>' > "$old_appcast"
print '<rss><channel><item><title>0.1.0</title></item><item><title>0.0.1</title><enclosure url="release.zip" /></item></channel></rss>' > "$new_appcast"
assert_fails release_policy_require_preserved_appcast_items "$old_appcast" "$new_appcast"
