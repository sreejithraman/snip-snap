...
base_ios_product_identifier="$(signing_policy_resolve_setting \
    "$base_settings" PRODUCT_BUNDLE_IDENTIFIER SnipSnapiOS)"
base_app_group_identifier="$(signing_policy_resolve_setting \
    "$base_settings" SNIP_SNAP_APP_GROUP_IDENTIFIER SnipSnapiOS)"
configured_dev_ios_product_identifier="$(signing_policy_resolve_setting \
    "$base_settings" SNIP_SNAP_DEV_IOS_PRODUCT_BUNDLE_IDENTIFIER SnipSnapiOS)"
configured_dev_app_group_identifier="$(signing_policy_resolve_setting \
    "$base_settings" SNIP_SNAP_DEV_APP_GROUP_IDENTIFIER SnipSnapiOS)"
[[ -n "$base_ios_product_identifier" ]] || fail "the iOS product bundle identifier is missing"
[[ -n "$base_app_group_identifier" ]] || fail "SNIP_SNAP_APP_GROUP_IDENTIFIER is missing"

dev_ios_product_identifier="${SNIP_SNAP_DEV_IOS_PRODUCT_BUNDLE_IDENTIFIER:-${configured_dev_ios_product_identifier:-$base_ios_product_identifier.dev}}"
dev_ios_share_product_identifier="$dev_ios_product_identifier.share"
dev_app_group_identifier="${SNIP_SNAP_DEV_APP_GROUP_IDENTIFIER:-${configured_dev_app_group_identifier:-$base_app_group_identifier.dev}}"
[[ "$dev_ios_product_identifier" != "$base_ios_product_identifier" ]] || \
...
typeset -gx SNIP_SNAP_IOS_PRODUCT_BUNDLE_IDENTIFIER="$dev_ios_product_identifier"
typeset -gx SNIP_SNAP_IOS_SHARE_PRODUCT_BUNDLE_IDENTIFIER="$dev_ios_share_product_identifier"
...
development_team="$(signing_policy_resolve_setting \
    "$cloud_dev_settings" DEVELOPMENT_TEAM SnipSnapiOS)"
cloudkit_container_identifier="$(signing_policy_resolve_setting \
    "$cloud_dev_settings" SNIP_SNAP_CLOUDKIT_CONTAINER_IDENTIFIER SnipSnapiOS)"
ios_app_entitlements="$(signing_policy_resolve_setting \
    "$cloud_dev_settings" CODE_SIGN_ENTITLEMENTS SnipSnapiOS)"
...
"$xcodebuild_tool" \
    ...
    "SNIP_SNAP_IOS_PRODUCT_BUNDLE_IDENTIFIER=$dev_ios_product_identifier" \
    "SNIP_SNAP_IOS_SHARE_PRODUCT_BUNDLE_IDENTIFIER=$dev_ios_share_product_identifier" \
    ...
    "SNIP_SNAP_IOS_APP_CODE_SIGN_ENTITLEMENTS=$ios_app_entitlements" \
