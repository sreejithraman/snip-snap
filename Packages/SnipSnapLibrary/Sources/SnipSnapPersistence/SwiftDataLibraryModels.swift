...
final class StoredListRecord {
  ...
  var colorPresetID: String?

  var color: SnipListColorPreset? {
    get { colorPresetID.flatMap(SnipListColorPreset.init(rawValue:)) }
    set { colorPresetID = newValue?.rawValue }
  }
  var position: Int
  ...
  init(_ list: SnipList) {
    ...
    colorPresetID = list.color?.rawValue
